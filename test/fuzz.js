...
// import nanomorph from '../'
import nanomorph from '../preact'

t('chaos monkey #1', function (t) {
  var a, b
...
t('fuzz tests', function (t) {
  ...
  // FIXME: these mysterious numbers may break mysterious cache
  let maxDepth = 7, maxProps = 5, maxOffset = 3
