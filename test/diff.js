...
t('append an element', function (t) {
  var a = html`<ul>
    <li id="a"></li>
    <li id="b"></li>
    <li id="c"></li>
...
t('handle non-id elements', function (t) {
  var a = html`<ul>
    <li></li>
    <li id="a"></li>
    <li id="b"></li>
...
t('copy over children', function (t) {
...
t('remove an element', function (t) {
...
t.skip('swap proxy elements', function (t) {
...
t('id match still morphs', function (t) {
...
t('remove orphaned keyed nodes', function (t) {
  var a = html`
    <div>
      <div>1</div>
      <li id="a">a</li>
...
t('nested without id', function (t) {
...
t.skip('disallow document fragments', function (t) {
  var a = html`<div><div>a</div></div>`
  var b = html`<div>a</div><div>b</div>`

  morph(a, b)
  // t.throws(morph.bind(null, a, b), /newTree should have one root node/, 'no fragments')
  t.end()
})
...
t.skip('allow document fragments', function (t) {
  ...
  var c = morph(a, b)
  t.equals(c.nodeType, 11, 'result is frag')
  t.equals(c.outerHTML, '<><div>a</div><div>b</div></>', 'outer html is ok')
  t.end()
})


// abstract morph
t('values: should replace a node', function (t) {
  t.plan(1)
...
t('values: should replace a component', function (t) {
  t.plan(2)
  function ComponentA () {
    return html`<div id="a">hello world</div>`
  }
  function ComponentB () {
    return html`<div id="b">bye moon</div>`
  }
...
t('values: should morph a node', function (t) {
  t.plan(1)
  var a = html`<p>hello world</p>`
...
t('values: should morph a node with namespaced attribute', function (t) {
  t.plan(1)
...
t('values: should ignore if node is same', function (t) {
  t.plan(1)
  var a = html`<p>hello world</p>`
...
t('nested: should replace a node', function (t) {
  t.plan(1)
...
t('nested: should append a node', function (t) {
  t.plan(1)
...
t('nested: should remove a node', function (t) {
  t.plan(1)
...
t.skip('nested: should update child nodes', function (t) {
  t.plan(1)
  var a = html`<main><p>hello world</p></main>`
  var b = html`<section><p>hello you</p></section>`
  var expected = '<main><p>hello you</p></main>'
  var res = morph(a.childNodes, b.childNodes)
  t.equal(res.outerHTML, expected, 'result was expected')
})
...
t.skip('isSameNode: should return a if true', function (t) {
  t.plan(1)
...
t.skip('isSameNode: should return b if false', function (t) {
  t.plan(1)
  var a = html`<div>YOLO</div>`
  var b = html`<div>FOMO</div>`
  b.isSameNode = function (el) {
...
t('lists: should append nodes', function (t) {
  t.plan(1)
  var a = html`<ul></ul>`
...
t('lists: should remove nodes', function (t) {
  t.plan(1)
...
t('selectables: should append nodes', function (t) {
  t.plan(1)
...
t('selectables: should append nodes (including optgroups)', function (t) {
  t.plan(1)
  var a = html`<select></select>`
...
t('selectables: should remove nodes', function (t) {
  t.plan(1)
...
t('selectables: should remove nodes (including optgroups)', function (t) {
  t.plan(1)
...
t('selectables: should add selected', function (t) {
  t.plan(1)
...
t('selectables: should add selected (xhtml)', function (t) {
  t.plan(1)
  var a = html`<select><option>1</option><option>2</option></select>`
...
t('selectables: should switch selected', function (t) {
  t.plan(1)
...
t('should replace nodes', function (t) {
  t.plan(1)
  var a = html`<ul><li>1</li><li>2</li><li>3</li><li>4</li><li>5</li></ul>`
...
t('should replace nodes after multiple iterations', function (t) {
  t.plan(2)
